...
namespace Client.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/FullName", ReplyAction="http://tempuri.org/IService1/FullNameResponse")]
        string FullName(string firstname, string lastname);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/FullName", ReplyAction="http://tempuri.org/IService1/FullNameResponse")]
        System.Threading.Tasks.Task<string> FullNameAsync(string firstname, string lastname);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<Client.ServiceReference1.IService1>, Client.ServiceReference1.IService1 {
        ...
        public string FullName(string firstname, string lastname) {
            return base.Channel.FullName(firstname, lastname);
        }
        
        public System.Threading.Tasks.Task<string> FullNameAsync(string firstname, string lastname) {
            return base.Channel.FullNameAsync(firstname, lastname);
        }
    }
}
