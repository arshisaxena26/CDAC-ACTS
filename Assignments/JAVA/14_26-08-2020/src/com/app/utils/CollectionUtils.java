...
public class CollectionUtils {
	public static ArrayList<Customer> populateSampleData() throws CustomerHandlingException {
		...
		customer = new Customer("Akshat", validateEmail("arshi@gmail.com"), validatePassword("@R$hi123"),
		...
		customer = new Customer("Shreyasi", validateEmail("shreyasi@gmail.com"), validatePassword("@R$hi123"),
				validateCustomerType("GOLD"), validateDateOfBirth("1995-11-16"), validateRegAmount(2500));
		customer.linkShippingAddr(new CustomerShippingAddress("Indore", "MadhyaPradesh", "India", "402030",
	...
	public static HashSet<Customer> populateHashSet() throws CustomerHandlingException {
		HashSet<Customer> customerSet = new HashSet<>(populateSampleData());
		return customerSet;
	}
}
