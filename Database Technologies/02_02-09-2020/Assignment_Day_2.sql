...
--	...
     ...
     SELECT ENAME, 'is earning' ,SAL, 'dollars'
	FROM EMP;
...
--7. Display the name of employee and annual salary of each employee. Annual sal must be calculated by considering sal, comm and bonus of 1000$ for each employee
     ...
     SELECT ENAME, (SAL+ifnull(COMM,0)+1000) AS 'Annual Salary'
	FROM EMP;
...
--3. List the name of employees who have joined the company after year 1981
     ...
     SELECT ENAME FROM EMP WHERE HIREDATE > '1981-12-31';

--4. List the name of employees who have joined the company in year 1981

     SELECT ENAME 
	FROM EMP 
	WHERE HIREDATE > '1980-12-31' AND HIREDATE < '1982-01-01';
...
--8. List the details of employees whose total salary (sal and commission) is more than $2000.
...
--2. Fetch list of all data dictionary in information schema and observe their naming convention
